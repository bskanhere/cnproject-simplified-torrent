...
public class BitField {
    ...
    public void setMissing(final int index) throws HavePieceException {
        if (bitset.get(index) != PieceStatus.HAVE) {
            bitset.set(index, PieceStatus.MISSING);
        } else {
            throw new HavePieceException();
        }
    }

    public void setRequested(final int index) throws HavePieceException {
        if (bitset.get(index) != PieceStatus.HAVE) {
    ...
    public void setHave(final int index) throws HavePieceException {
        if (bitset.get(index) != PieceStatus.HAVE) {
