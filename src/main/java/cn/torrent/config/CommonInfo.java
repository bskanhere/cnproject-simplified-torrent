...
public class CommonInfo {
    ...
    private CommonInfo(int numberOfPreferredNeighbors, int unChokingInterval, int optimisticUnChokingInterval, String fileName, int fileSize, int pieceSize) {
    ...
    public static CommonInfo from(final String cfgFilePath) throws IOException {
        ...
        return new CommonInfo(numberOfPreferredNeighbors, unChokingInterval, optimisticUnChokingInterval, fileName, fileSize, pieceSize);
